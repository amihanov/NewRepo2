...
( NAME = N'$(db)_PRIMARY', FILENAME = N'$(RutaPrimary)\$(db)\$(db)_PRIMARY.mdf', SIZE = 250MB, MAXSIZE = UNLIMITED, FILEGROWTH = 128MB)
,FILEGROUP [ftfg_ISKEYDB_DATA]
( NAME = N'$(db)_ftfg_ISKEYDB_DATA', FILENAME = N'$(RutaSecondary)\$(db)\$(db)_ftfg_ISKEYDB_DATA.ndf', SIZE = 250MB, MAXSIZE = UNLIMITED, FILEGROWTH = 128MB)
LOG ON
( NAME = N'$(db)_LOG', FILENAME = N'$(RutaLog)\$(db)\$(db)_LOG.ldf', SIZE = 50MB , MAXSIZE = UNLIMITED, FILEGROWTH = 32MB)
