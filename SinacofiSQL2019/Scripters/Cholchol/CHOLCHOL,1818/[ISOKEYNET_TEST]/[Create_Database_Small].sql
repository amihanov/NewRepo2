...
( NAME = N'$(db)_PRIMARY', FILENAME = N'$(RutaPrimary)\$(db)\$(db)_PRIMARY.mdf', SIZE = 10MB, MAXSIZE = UNLIMITED, FILEGROWTH = 10MB)
,FILEGROUP [ftfg_ISKEYDB_DATA]
( NAME = N'$(db)_ftfg_ISKEYDB_DATA', FILENAME = N'$(RutaSecondary)\$(db)\$(db)_ftfg_ISKEYDB_DATA.ndf', SIZE = 10MB, MAXSIZE = UNLIMITED, FILEGROWTH = 10MB)
LOG ON
