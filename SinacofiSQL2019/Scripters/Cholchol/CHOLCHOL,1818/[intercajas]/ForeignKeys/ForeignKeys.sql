...
REFERENCES [dbo].[tblInstitucion] ([nIdInstitucion])
GO
ALTER TABLE [dbo].[tblIndicadorResumen] WITH CHECK CHECK CONSTRAINT [FK_tblIndicadorResumen_tblInstitucion]
GO
...
REFERENCES [dbo].[tblInstitucion] ([nIdInstitucion])
GO
ALTER TABLE [dbo].[tblIndicadorResumen] WITH CHECK CHECK CONSTRAINT [FK_tblIndicadorResumen_tblInstitucion1]
GO
...
REFERENCES [dbo].[tblPeriodo] ([nPeriodo])
GO
ALTER TABLE [dbo].[tblIndicadorResumen] WITH CHECK CHECK CONSTRAINT [FK_tblIndicadorResumen_tblPeriodo]
GO
...
GO
ALTER TABLE [dbo].[tblIndicadorResumen] WITH CHECK CHECK CONSTRAINT [FK_tblIndicadorResumen_tblPeriodoMora]
GO
...
REFERENCES [dbo].[tblEstado] ([iIdEstado])
GO
ALTER TABLE [dbo].[tblRegistroConsolidacion] WITH CHECK CHECK CONSTRAINT [FK_tblRegistroConsolidacion_tblEstado]
GO
...
REFERENCES [dbo].[tblPeriodo] ([nPeriodo])
GO
ALTER TABLE [dbo].[tblRegistroConsolidacion] WITH CHECK CHECK CONSTRAINT [FK_tblRegistroConsolidacion_tblPeriodo]
GO
...
REFERENCES [dbo].[tblUsuario] ([iRut])
GO
ALTER TABLE [dbo].[tblRegistroConsolidacion] WITH CHECK CHECK CONSTRAINT [FK_tblRegistroConsolidacion_tblUsuario]
GO
...
REFERENCES [dbo].[tblInstitucion] ([nIdInstitucion])
GO
ALTER TABLE [dbo].[tblResumenConsolidacion] WITH CHECK CHECK CONSTRAINT [FK_tblResumenConsolidacion_tblInstitucion]
GO
...
REFERENCES [dbo].[tblInstitucion] ([nIdInstitucion])
GO
ALTER TABLE [dbo].[tblResumenConsolidacion] WITH CHECK CHECK CONSTRAINT [FK_tblResumenConsolidacion_tblInstitucion1]
GO
...
REFERENCES [dbo].[tblRegistroConsolidacion] ([nPeriodo], [dFechaRegistro])
GO
ALTER TABLE [dbo].[tblResumenConsolidacion] WITH CHECK CHECK CONSTRAINT [FK_tblResumenConsolidacion_tblRegistroConsolidacion]
GO
