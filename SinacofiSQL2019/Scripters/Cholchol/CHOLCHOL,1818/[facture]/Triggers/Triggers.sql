...
ON [dbo].[dto_rece_docu] for INSERT, update   
as
declare
	@v_codi_serv varchar(30),
	@v_esta_reto varchar(30),
...
ON [dbo].[dte_desc_item]  for insert   AS
BEGIN 
  declare
...
ON [dbo].[dte_desc_item_p]  for insert   AS
BEGIN 
  declare
  @res         varchar (10),  @p_codi      varchar(5), 
  @hay_era     varchar(2),    @hay_err     varchar(2), 
...
ON [dbo].[dte_desc_reca]  for insert   AS
BEGIN
 declare
   @res         varchar (10),  @p_codi      varchar(5),
...
ON [dbo].[dte_desc_reca_p]  for insert   AS
BEGIN
 declare
   @res         varchar(10),   @p_codi      varchar(5),
   @hay_era     varchar(3),    @MNSG_ERRO   varchar(2000),
...
ON [dbo].[dte_deta_acec]  for insert   AS
BEGIN   
  declare
  @res       	varchar (10),  	@p_codi        	varchar(5), 
  @hay_era   	varchar(2),    	@hay_err       	varchar(2), 
...
ON [dbo].[dte_deta_acec_p]  for insert   AS
BEGIN   
  declare
  @res   	varchar(10),	@p_codi		varchar(5), 
  @hay_era 	varchar(2),     @hay_err   	varchar(2), 
...
ON [dbo].[dte_deta_codi]  for insert   AS
BEGIN 
 declare
  @res 		varchar (10), 	@p_codi 	varchar(5), 
  @hay_era 	varchar(2), 	@hay_err 	varchar(2), 
...
ON [dbo].[dte_deta_codi_p]  for insert   AS
BEGIN 
 declare
  @res   	varchar (10),   @p_codi   	varchar(5), 
  @hay_era 	varchar(2),   	@hay_err   	varchar(2), 
...
ON [dbo].[dte_deta_prse] for insert AS
BEGIN
 declare
...
ON [dbo].[dte_docu_refe] for insert   AS
BEGIN 
 declare
  @res   	varchar (10), 	@p_codi 	varchar(5), 
  @hay_era 	varchar(2), 	@hay_err	varchar(2),
...
ON [dbo].[dte_docu_refe_p] for insert   AS
BEGIN 
 declare
  @res   	varchar (10), 	@p_codi 	varchar(5), 
  @hay_era 	varchar(2), 	@hay_err	varchar(2),
...
ON [dbo].[dte_reca_item]  for insert   AS
  declare
  @res          varchar (10),  @p_codi       varchar(5), 
  @hay_era      varchar(2),    @hay_err      varchar(2), 
  @fecha        varchar(10),   @mensaje      varchar(2000),
...
ON [dbo].[dte_reca_item_p]  for insert   AS
  declare
  @res   	varchar(10),   @p_codi       varchar(5), 
  @hay_era 	varchar(2),    @hay_err      varchar(2), 
  @fecha  	varchar(10),   @mensaje      varchar(2000),
...
ON [dbo].[dte_suma_impu]  for insert   AS
BEGIN
  declare
   @res       varchar (10),  @p_codi    varchar(5),
   @hay_era   varchar(3),    @MNSG_ERRO  varchar(2000),
...
ON [dbo].[dte_suma_impu_p]  for insert   AS
BEGIN
  declare
   @res       	varchar (10),  @p_codi       varchar(5),
   @hay_era   	varchar(3),    @MNSG_ERRO    varchar(2000),
...
ON [dbo].[dte_suca_item]  for  insert AS
BEGIN
 declare
   @res       varchar (10),  @p_codi    varchar(5),
...
ON [dbo].[dte_suca_item_p]  for  insert AS
BEGIN
 declare
   @res       	varchar(10),   @p_codi       varchar(5),
   @hay_err   	varchar(3),    @MNSG_ERRO    varchar(2000),
...
ON [dbo].[dto_enca_docu_p] for update as 
BEGIN
