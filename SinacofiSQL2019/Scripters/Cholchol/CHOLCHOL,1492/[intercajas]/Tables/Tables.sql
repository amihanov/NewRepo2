...
GO
--SqlScripter----[dbo].[tblParametro202008].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
SET ANSI_PADDING ON
...
CREATE TABLE [dbo].[tblParametro202008](
	[iIdParametro] [bigint] NOT NULL,
	[vcParametro] [nvarchar](50) NOT NULL,
	[iIdTipoParametro] [int] NOT NULL,
	[vcValor] [nvarchar](250) NOT NULL,
...
GO
--SqlScripter----[dbo].[tblParametro202009].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
SET ANSI_PADDING ON
...
CREATE TABLE [dbo].[tblParametro202009](
	[iIdParametro] [bigint] NOT NULL,
	[vcParametro] [nvarchar](50) NOT NULL,
	[iIdTipoParametro] [int] NOT NULL,
	[vcValor] [nvarchar](250) NOT NULL,
