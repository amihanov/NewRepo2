...
GO
--SqlScripter----[dbo].[DF__BS_INDICA__WEIGH__5066D2A5].sql
GO
ALTER TABLE [dbo].[BS_INDICATORSREL] ADD CONSTRAINT [DF__BS_INDICA__WEIGH__5066D2A5] DEFAULT (0) FOR [WEIGHT_PERC]
GO
...
GO
--SqlScripter----[dbo].[DF__IK_PEOPLE__ALT_E__55959C16].sql
GO
ALTER TABLE [dbo].[IK_PEOPLE] ADD CONSTRAINT [DF__IK_PEOPLE__ALT_E__55959C16] DEFAULT (NULL) FOR [ALT_EMAIL]
GO
--SqlScripter----[dbo].[DF__IK_PEOPLE__Q_SEC__53AD53A4].sql
GO
ALTER TABLE [dbo].[IK_PEOPLE] ADD CONSTRAINT [DF__IK_PEOPLE__Q_SEC__53AD53A4] DEFAULT (NULL) FOR [Q_SEC]
GO
--SqlScripter----[dbo].[DF__IK_PEOPLE__R_SEC__54A177DD].sql
GO
ALTER TABLE [dbo].[IK_PEOPLE] ADD CONSTRAINT [DF__IK_PEOPLE__R_SEC__54A177DD] DEFAULT (NULL) FOR [R_SEC]
GO
...
GO
--SqlScripter----[dbo].[DF__PROCESOS__L_VENC__151102AD].sql
GO
ALTER TABLE [dbo].[PROCESOS] ADD CONSTRAINT [DF__PROCESOS__L_VENC__151102AD] DEFAULT (0) FOR [L_VENCIMIENTO_INDIVIDUAL]
GO
...
GO
--SqlScripter----[dbo].[DF__TAREASREV__L_VEN__141CDE74].sql
GO
ALTER TABLE [dbo].[TAREASREVISION] ADD CONSTRAINT [DF__TAREASREV__L_VEN__141CDE74] DEFAULT (0) FOR [L_VENCIMIENTONOTIFICADO]
GO
...
GO
--SqlScripter----[dbo].[DF__TODO__ISLINKLIST__3528CC84].sql
GO
ALTER TABLE [dbo].[TODO] ADD CONSTRAINT [DF__TODO__ISLINKLIST__3528CC84] DEFAULT (0) FOR [ISLINKLIST]
GO
