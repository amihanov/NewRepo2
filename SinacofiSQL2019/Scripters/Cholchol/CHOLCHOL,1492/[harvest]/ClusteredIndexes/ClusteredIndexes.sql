...
GO
--SqlScripter----[dbo].[harusdpackageinfo].[$harus_u00003d5f00000000].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[harusdpackageinfo] ADD CONSTRAINT [$harus_u00003d5f00000000] PRIMARY KEY CLUSTERED (
	[formobjid] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[harusdplatforminfo].[$harus_u00003d6300000000].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[harusdplatforminfo] ADD CONSTRAINT [$harus_u00003d6300000000] PRIMARY KEY CLUSTERED (
	[formobjid] ASC
) ON [PRIMARY]
