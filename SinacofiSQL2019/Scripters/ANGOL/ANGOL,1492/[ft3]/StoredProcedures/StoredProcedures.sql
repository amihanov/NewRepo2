...
GO
--SqlScripter----[dbo].[listbd].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[listbd]') IS NULL EXEC('CREATE PROCEDURE [dbo].[listbd] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[listbd]
AS
exec sp_helpdb
GO;
GO
...
GO
--SqlScripter----[dbo].[spFT3ConsultaEstrucVersArchivo].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[spFT3ConsultaEstrucVersArchivo]') IS NULL EXEC('CREATE PROCEDURE [dbo].[spFT3ConsultaEstrucVersArchivo] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[spFT3ConsultaEstrucVersArchivo]
@vcError varchar(255)  OUTPUT,
   @vcCodMensaje varchar(3),
   @vcPeriodoMens varchar(8)
AS 
   
   /*
   *   Generated by SQL Server Migration Assistant for Sybase version 5.2.1260.
   *   
   *    *  Servicio:       spFT3ConsultaEstrucVersArchivo
   *    *  Objetivo:       Consulta estructura de una version segun el periodo
   *    *  Autor Creaci=n: Jonathan Arce
   *    *  Fecha Creaci=n: 21/10/2021
   *   
   *    *  Autor Modific.:
   *    *  Fecha Modific.:
   *    *
   *    *  Entrada:        @vcCodMensaje         Codigo de archivo.
   *    *
   *    *  Salida:         @error                error de salida
   *    *
   *    *
   ...
   */
   ...
   BEGIN
      ...
      SELECT dbo.tblVersionEstructura.codMensaje, 
             dbo.tblVersionEstructura.desMensaje, 
             dbo.tblVersionEstructura.nomMensaje, 
             dbo.tblVersionEstructura.lrgMensaje, 
             dbo.tblVersionEstructura.bq1Mensaje, 
             dbo.tblVersionEstructura.bq2Mensaje, 
             dbo.tblVersionEstructura.bq3Mensaje,
             dbo.tblVersionEstructura.versionMens
      FROM dbo.tblVersionEstructura
      WHERE dbo.tblVersionEstructura.nomMensaje = @vcCodMensaje
	  AND @vcPeriodoMens BETWEEN periodoInic AND periodoFin
...
GO
--SqlScripter----[dbo].[spFT3ConsultaVersionesArchivo].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[spFT3ConsultaVersionesArchivo]') IS NULL EXEC('CREATE PROCEDURE [dbo].[spFT3ConsultaVersionesArchivo] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[spFT3ConsultaVersionesArchivo]
@vcError varchar(255)  OUTPUT,
   @vcCodMensaje varchar(3)
AS 
   ...
   *   Generated by SQL Server Migration Assistant for Sybase version 5.2.1260.
   *   
   *    *  Servicio:       spFT3ConsultaVersionesArchivo
   *    *  Objetivo:       Consulta si existen versiones asociadas a un archivo en especifico
   *    *  Autor Creaci=n: Jonathan Arce
   *    *  Fecha Creaci=n: 21/10/2021
   *   
   *    *  Autor Modific.:
   ...
   */
   ...
   BEGIN
      ...
      SELECT DISTINCT dbo.tblVersionEstructura.versionMens
      FROM dbo.tblVersionEstructura
      WHERE dbo.tblVersionEstructura.nomMensaje = @vcCodMensaje
...
GO
--SqlScripter----[dbo].[spFT3ConsVersionFormatFecha].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[spFT3ConsVersionFormatFecha]') IS NULL EXEC('CREATE PROCEDURE [dbo].[spFT3ConsVersionFormatFecha] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[spFT3ConsVersionFormatFecha]
@vcError varchar(255)  OUTPUT,
   @vcCodMensaje varchar(3)
AS 
   ...
   *   Generated by SQL Server Migration Assistant for Sybase version 5.2.1260.
   *   
   *    *  Servicio:       spFT3ConsVersionFormatFecha
   *    *  Objetivo:       Consulta si existen versiones asociadas a un archivo en especifico
   *    *  Autor Creaci=n: Jonathan Arce
   *    *  Fecha Creaci=n: 25/10/2021
   *   
   *    *  Autor Modific.:
   *    *  Fecha Modific.:
   *    *
   ...
   */
   ...
   BEGIN
      ...
      SELECT DISTINCT dbo.tblVersionEstructura.tipoFormat
      FROM dbo.tblVersionEstructura
      WHERE dbo.tblVersionEstructura.nomMensaje = @vcCodMensaje
            ...
            if exists (select 1 from tblUsuario
                ...
                begin
                    ...
                    if not exists (select 1 from tblUsuario
                        ...
                        if not exists (select 1 from tblUsuario
                                       where vcCodigoUsuario = @vcCodigoUsuario
                                         and vcCodigoPerfil in ('01','02','03','04','06','07'))
