...
EXEC msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Subplan_1',
		...
		@os_run_priority=0,
		@subsystem=N'SSIS',
		@command=N'/Server "$(ESCAPE_NONE(SRVR))" /SQL "Maintenance Plans\BackupFull" /set "\Package\Subplan_1.Disable;false"',
		@database_name=N'',
		@flags=0
