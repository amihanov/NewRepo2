...
GO
--SqlScripter----[dbo].[DF__hardelver__DELET__72A872BE].sql
GO
ALTER TABLE [dbo].[hardelversproc] ADD CONSTRAINT [DF__hardelver__DELET__72A872BE] DEFAULT ('N') FOR [DELETEBYOWNER]
GO
...
GO
--SqlScripter----[dbo].[DF__HARPEERRE__CREAT__31CED39A].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEW] ADD CONSTRAINT [DF__HARPEERRE__CREAT__31CED39A] DEFAULT (getutcdate()) FOR [CREATIONTIME]
GO
--SqlScripter----[dbo].[DF__HARPEERRE__MODIF__32C2F7D3].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEW] ADD CONSTRAINT [DF__HARPEERRE__MODIF__32C2F7D3] DEFAULT (getutcdate()) FOR [MODIFIEDTIME]
GO
--SqlScripter----[dbo].[DF__HARPEERRE__COMME__45D5CC47].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] ADD CONSTRAINT [DF__HARPEERRE__COMME__45D5CC47] DEFAULT ('I') FOR [COMMENTTYPE]
GO
--SqlScripter----[dbo].[DF__HARPEERRE__CREAT__46C9F080].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] ADD CONSTRAINT [DF__HARPEERRE__CREAT__46C9F080] DEFAULT (getutcdate()) FOR [CREATIONTIME]
GO
--SqlScripter----[dbo].[DF__HARPEERREV__VOTE__3B583DD4].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWREVIEWER] ADD CONSTRAINT [DF__HARPEERREV__VOTE__3B583DD4] DEFAULT ('P') FOR [VOTE]
GO
...
GO
--SqlScripter----[dbo].[DF__harudp__ALLOWADD__739C96F7].sql
GO
ALTER TABLE [dbo].[harudp] ADD CONSTRAINT [DF__harudp__ALLOWADD__739C96F7] DEFAULT ('Y') FOR [ALLOWADDITIONALCOMMANDS]
GO
...
GO
--SqlScripter----[dbo].[DF__harversio__ISDAT__7B3DB8BF].sql
GO
ALTER TABLE [dbo].[harversiondata] ADD CONSTRAINT [DF__harversio__ISDAT__7B3DB8BF] DEFAULT ('0') FOR [ISDATAINCHUNKS]
GO
...
GO
--SqlScripter----[dbo].[DF__USCMMAPPE__SCM_C__00F69215].sql
GO
ALTER TABLE [dbo].[USCMMAPPER] ADD CONSTRAINT [DF__USCMMAPPE__SCM_C__00F69215] DEFAULT (getutcdate()) FOR [SCM_CREATION_DATE]
GO
