...
GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENTSEQ].[PK__HARPEERR__7AF8B18745E58E84].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTSEQ] ADD CONSTRAINT [PK__HARPEERR__7AF8B18745E58E84] PRIMARY KEY CLUSTERED (
	[SeqID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[HARPEERREVIEWSEQ].[PK__HARPEERR__7AF8B187DCB1BC40].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[HARPEERREVIEWSEQ] ADD CONSTRAINT [PK__HARPEERR__7AF8B187DCB1BC40] PRIMARY KEY CLUSTERED (
	[SeqID] ASC
) ON [PRIMARY]
...
GO
--SqlScripter----[dbo].[HARRPTSQLSEQ].[PK__HARRPTSQ__7AF8B187B3A2744F].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[HARRPTSQLSEQ] ADD CONSTRAINT [PK__HARRPTSQ__7AF8B187B3A2744F] PRIMARY KEY CLUSTERED (
	[SeqID] ASC
) ON [PRIMARY]
