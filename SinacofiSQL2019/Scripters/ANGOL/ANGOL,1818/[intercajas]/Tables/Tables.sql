...
GO
--SqlScripter----[dbo].[MSBTMPiInstitucionesParticipantes].sql
GO
SET ANSI_NULLS ON
...
CREATE TABLE [dbo].[MSBTMPiInstitucionesParticipantes](
	[nPeriodo] [int] NULL,
	[nIdInstitucion] [int] NULL,
	[vcNombreCorto] [nvarchar](10) NULL,
	[iCorrelativoAfiliado] [int] NULL,
	[iCorrelativoDeuda] [int] NULL,
	[iCorrelativoConsolidacion] [int] NULL
)
ON [PRIMARY]
