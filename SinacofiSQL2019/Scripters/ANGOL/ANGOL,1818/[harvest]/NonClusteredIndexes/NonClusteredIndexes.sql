...
GO
--SqlScripter----[dbo].[HARBIGFILEDATA].[HARBIGFILEDATA_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [HARBIGFILEDATA_IND] ON [dbo].[HARBIGFILEDATA] (
...
GO
--SqlScripter----[dbo].[HARPEERREVIEW].[HARPEERREVIEW_RVWRIDCRTRID_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [HARPEERREVIEW_RVWRIDCRTRID_IND] ON [dbo].[HARPEERREVIEW] (
	[REVIEWOBJID] ASC,
	[CREATORID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[HARPEERREVIEWATTACHMENT].[HARPEERATTACHMENT_REVIEWID_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE NONCLUSTERED INDEX [HARPEERATTACHMENT_REVIEWID_IND] ON [dbo].[HARPEERREVIEWATTACHMENT] (
	[REVIEWOBJID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENT].[HARPEERCOMMENT_RVWCMNTVER_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [HARPEERCOMMENT_RVWCMNTVER_IND] ON [dbo].[HARPEERREVIEWCOMMENT] (
	[REVIEWOBJID] ASC,
	[COMMENTOBJID] ASC,
	[VERSIONOBJID] ASC
) ON [PRIMARY]
...
GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENT].[HARPEERCOMMENT_RVWIDCRTRID_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [HARPEERCOMMENT_RVWIDCRTRID_IND] ON [dbo].[HARPEERREVIEWCOMMENT] (
	[REVIEWOBJID] ASC,
	[COMMENTOBJID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENT].[HARPEERCOMMENT_VOBJID_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE NONCLUSTERED INDEX [HARPEERCOMMENT_VOBJID_IND] ON [dbo].[HARPEERREVIEWCOMMENT] (
	[VERSIONOBJID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENTATTACHMENT].[HARPEERCMNTATTCHMNT_CMNTID_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE NONCLUSTERED INDEX [HARPEERCMNTATTCHMNT_CMNTID_IND] ON [dbo].[HARPEERREVIEWCOMMENTATTACHMENT] (
	[COMMENTOBJID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENTDATA].[HARPEERDATA_CMNTIDCRTRID_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE NONCLUSTERED INDEX [HARPEERDATA_CMNTIDCRTRID_IND] ON [dbo].[HARPEERREVIEWCOMMENTDATA] (
	[COMMENTOBJID] ASC,
	[CREATORID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[HARPEERREVIEWREVIEWER].[HARPEERREVIEWER_RVWCRTR_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [HARPEERREVIEWER_RVWCRTR_IND] ON [dbo].[HARPEERREVIEWREVIEWER] (
	[REVIEWOBJID] ASC,
	[REVIEWERID] ASC
) ON [PRIMARY]
...
GO
--SqlScripter----[dbo].[HARRPTSQL].[HARRPTSQL_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [HARRPTSQL_IND] ON [dbo].[HARRPTSQL] (
	[NAME] ASC
) ON [PRIMARY]
...
GO
--SqlScripter----[dbo].[harversions].[HARVERSIONS_PATHVER_IND].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE NONCLUSTERED INDEX [HARVERSIONS_PATHVER_IND] ON [dbo].[harversions] (
	[PATHVERSIONID] ASC
) ON [PRIMARY]
...
GO
--SqlScripter----[dbo].[USCMMAPPER].[VERSIONOBJID_FK_INDEX].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [VERSIONOBJID_FK_INDEX] ON [dbo].[USCMMAPPER] (
	[VERSIONOBJID] ASC
) ON [PRIMARY]
