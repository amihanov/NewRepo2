...
GO
--SqlScripter----[dbo].[HARBIGFILEDATA].[HARBIGDATA_VERSIONDATAID_FK].sql
GO
ALTER TABLE [dbo].[HARBIGFILEDATA] WITH NOCHECK ADD CONSTRAINT [HARBIGDATA_VERSIONDATAID_FK] FOREIGN KEY ([VERSIONDATAOBJID])
REFERENCES [dbo].[harversiondata] ([versiondataobjid])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARBIGFILEDATA] WITH CHECK CHECK CONSTRAINT [HARBIGDATA_VERSIONDATAID_FK]
GO
...
GO
--SqlScripter----[dbo].[HARCPMSTATE].[HARCPMSTATE_SRCENVOBJID_FK].sql
GO
ALTER TABLE [dbo].[HARCPMSTATE] WITH NOCHECK ADD CONSTRAINT [HARCPMSTATE_SRCENVOBJID_FK] FOREIGN KEY ([SRCENVOBJID])
REFERENCES [dbo].[harenvironment] ([envobjid])
GO
ALTER TABLE [dbo].[HARCPMSTATE] WITH CHECK CHECK CONSTRAINT [HARCPMSTATE_SRCENVOBJID_FK]
GO
--SqlScripter----[dbo].[HARCPMSTATE].[HARCPMSTATE_TGTENVOBJID_FK].sql
GO
ALTER TABLE [dbo].[HARCPMSTATE] WITH NOCHECK ADD CONSTRAINT [HARCPMSTATE_TGTENVOBJID_FK] FOREIGN KEY ([TGTENVOBJID])
REFERENCES [dbo].[harenvironment] ([envobjid])
GO
ALTER TABLE [dbo].[HARCPMSTATE] WITH CHECK CHECK CONSTRAINT [HARCPMSTATE_TGTENVOBJID_FK]
GO
...
GO
--SqlScripter----[dbo].[harenvironment].[HARENVIRONMENT_TEMPLATEID_FK].sql
GO
ALTER TABLE [dbo].[harenvironment] WITH NOCHECK ADD CONSTRAINT [HARENVIRONMENT_TEMPLATEID_FK] FOREIGN KEY ([TEMPLATEID])
REFERENCES [dbo].[harenvironment] ([envobjid])
GO
ALTER TABLE [dbo].[harenvironment] WITH CHECK CHECK CONSTRAINT [HARENVIRONMENT_TEMPLATEID_FK]
GO
...
GO
--SqlScripter----[dbo].[HARPEERREVIEW].[HARPEERREVIEW_CREATORID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEW] WITH NOCHECK ADD CONSTRAINT [HARPEERREVIEW_CREATORID_FK] FOREIGN KEY ([CREATORID])
REFERENCES [dbo].[harallusers] ([usrobjid])
GO
ALTER TABLE [dbo].[HARPEERREVIEW] WITH CHECK CHECK CONSTRAINT [HARPEERREVIEW_CREATORID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEW].[HARPEERREVIEW_PACKAGEID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEW] WITH NOCHECK ADD CONSTRAINT [HARPEERREVIEW_PACKAGEID_FK] FOREIGN KEY ([PACKAGEOBJID])
REFERENCES [dbo].[harpackage] ([packageobjid])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARPEERREVIEW] WITH CHECK CHECK CONSTRAINT [HARPEERREVIEW_PACKAGEID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEW].[HARPEERREVIEW_PRREVIEWERID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEW] WITH NOCHECK ADD CONSTRAINT [HARPEERREVIEW_PRREVIEWERID_FK] FOREIGN KEY ([PRIMARYREVIEWERID])
REFERENCES [dbo].[harallusers] ([usrobjid])
GO
ALTER TABLE [dbo].[HARPEERREVIEW] WITH CHECK CHECK CONSTRAINT [HARPEERREVIEW_PRREVIEWERID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWATTACHMENT].[HARPEERATTACHMENT_REVIEWID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWATTACHMENT] WITH NOCHECK ADD CONSTRAINT [HARPEERATTACHMENT_REVIEWID_FK] FOREIGN KEY ([REVIEWOBJID])
REFERENCES [dbo].[HARPEERREVIEW] ([REVIEWOBJID])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARPEERREVIEWATTACHMENT] WITH CHECK CHECK CONSTRAINT [HARPEERATTACHMENT_REVIEWID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENT].[HARPEERCOMMENT_REVIEWID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENT] WITH NOCHECK ADD CONSTRAINT [HARPEERCOMMENT_REVIEWID_FK] FOREIGN KEY ([REVIEWOBJID])
REFERENCES [dbo].[HARPEERREVIEW] ([REVIEWOBJID])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENT] WITH CHECK CHECK CONSTRAINT [HARPEERCOMMENT_REVIEWID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENT].[HARPEERCOMMENT_VERSIONID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENT] WITH NOCHECK ADD CONSTRAINT [HARPEERCOMMENT_VERSIONID_FK] FOREIGN KEY ([VERSIONOBJID])
REFERENCES [dbo].[harversions] ([versionobjid])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENT] WITH CHECK CHECK CONSTRAINT [HARPEERCOMMENT_VERSIONID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENTATTACHMENT].[HARPEERCMNTATTCH_COMMENTID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTATTACHMENT] WITH NOCHECK ADD CONSTRAINT [HARPEERCMNTATTCH_COMMENTID_FK] FOREIGN KEY ([COMMENTOBJID])
REFERENCES [dbo].[HARPEERREVIEWCOMMENT] ([COMMENTOBJID])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTATTACHMENT] WITH CHECK CHECK CONSTRAINT [HARPEERCMNTATTCH_COMMENTID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENTDATA].[HARPEERCOMMENTDATA_CMNTID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] WITH NOCHECK ADD CONSTRAINT [HARPEERCOMMENTDATA_CMNTID_FK] FOREIGN KEY ([COMMENTOBJID])
REFERENCES [dbo].[HARPEERREVIEWCOMMENT] ([COMMENTOBJID])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] WITH CHECK CHECK CONSTRAINT [HARPEERCOMMENTDATA_CMNTID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWCOMMENTDATA].[HARPEERCOMMENTDATA_CRTRID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] WITH NOCHECK ADD CONSTRAINT [HARPEERCOMMENTDATA_CRTRID_FK] FOREIGN KEY ([CREATORID])
REFERENCES [dbo].[harallusers] ([usrobjid])
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] WITH CHECK CHECK CONSTRAINT [HARPEERCOMMENTDATA_CRTRID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWREVIEWER].[HARPEERREVIEWER_REVIEWERID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWREVIEWER] WITH NOCHECK ADD CONSTRAINT [HARPEERREVIEWER_REVIEWERID_FK] FOREIGN KEY ([REVIEWERID])
REFERENCES [dbo].[harallusers] ([usrobjid])
GO
ALTER TABLE [dbo].[HARPEERREVIEWREVIEWER] WITH CHECK CHECK CONSTRAINT [HARPEERREVIEWER_REVIEWERID_FK]
GO
--SqlScripter----[dbo].[HARPEERREVIEWREVIEWER].[HARPEERREVIEWER_REVIEWID_FK].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWREVIEWER] WITH NOCHECK ADD CONSTRAINT [HARPEERREVIEWER_REVIEWID_FK] FOREIGN KEY ([REVIEWOBJID])
REFERENCES [dbo].[HARPEERREVIEW] ([REVIEWOBJID])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[HARPEERREVIEWREVIEWER] WITH CHECK CHECK CONSTRAINT [HARPEERREVIEWER_REVIEWID_FK]
GO
...
GO
--SqlScripter----[dbo].[USCMMAPPER].[USCMMAPPER_VERSIONOBJID_FK].sql
GO
ALTER TABLE [dbo].[USCMMAPPER] WITH NOCHECK ADD CONSTRAINT [USCMMAPPER_VERSIONOBJID_FK] FOREIGN KEY ([VERSIONOBJID])
REFERENCES [dbo].[harversions] ([versionobjid])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[USCMMAPPER] WITH CHECK CHECK CONSTRAINT [USCMMAPPER_VERSIONOBJID_FK]
GO
