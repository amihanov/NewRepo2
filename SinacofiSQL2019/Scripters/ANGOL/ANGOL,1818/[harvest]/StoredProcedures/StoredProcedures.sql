...
GO
--SqlScripter----[dbo].[GetNewSeqVal_HARAGQSYNCHUPDATESSEQ].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[GetNewSeqVal_HARAGQSYNCHUPDATESSEQ]') IS NULL EXEC('CREATE PROCEDURE [dbo].[GetNewSeqVal_HARAGQSYNCHUPDATESSEQ] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[GetNewSeqVal_HARAGQSYNCHUPDATESSEQ]
AS begin declare @NewSeqValue int set NOCOUNT ON begin tran save tran seq insert into HARAGQSYNCHUPDATESSEQ default values set @NewSeqValue = scope_identity() rollback tran seq commit return @NewSeqValue end
GO
...
GO
--SqlScripter----[dbo].[GetNewSeqVal_HARPEERREVIEWCOMMENTSEQ].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[GetNewSeqVal_HARPEERREVIEWCOMMENTSEQ]') IS NULL EXEC('CREATE PROCEDURE [dbo].[GetNewSeqVal_HARPEERREVIEWCOMMENTSEQ] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[GetNewSeqVal_HARPEERREVIEWCOMMENTSEQ]
AS begin declare @NewSeqValue int set NOCOUNT ON begin tran save tran seq insert into HARPEERREVIEWCOMMENTSEQ default values set @NewSeqValue = scope_identity() rollback tran seq commit return @NewSeqValue end
GO

GO
--SqlScripter----[dbo].[GetNewSeqVal_HARPEERREVIEWSEQ].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[GetNewSeqVal_HARPEERREVIEWSEQ]') IS NULL EXEC('CREATE PROCEDURE [dbo].[GetNewSeqVal_HARPEERREVIEWSEQ] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[GetNewSeqVal_HARPEERREVIEWSEQ]
AS begin declare @NewSeqValue int set NOCOUNT ON begin tran save tran seq insert into HARPEERREVIEWSEQ default values set @NewSeqValue = scope_identity() rollback tran seq commit return @NewSeqValue end
GO
...
GO
--SqlScripter----[dbo].[GetNewSeqVal_HARRPTSQLSEQ].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[GetNewSeqVal_HARRPTSQLSEQ]') IS NULL EXEC('CREATE PROCEDURE [dbo].[GetNewSeqVal_HARRPTSQLSEQ] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
ALTER PROCEDURE [dbo].[GetNewSeqVal_HARRPTSQLSEQ]
AS begin declare @NewSeqValue int set NOCOUNT ON begin tran save tran seq insert into HARRPTSQLSEQ default values set @NewSeqValue = scope_identity() rollback tran seq commit return @NewSeqValue end
GO
