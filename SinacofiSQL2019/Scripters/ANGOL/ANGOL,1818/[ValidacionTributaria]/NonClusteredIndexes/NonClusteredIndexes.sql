...
GO
--SqlScripter----[dbo].[consulta].[i1].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE NONCLUSTERED INDEX [i1] ON [dbo].[consulta] (
	[fechaCons] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[consulta].[i3].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
CREATE NONCLUSTERED INDEX [i3] ON [dbo].[consulta] (
	[idCons] ASC
) ON [PRIMARY]
