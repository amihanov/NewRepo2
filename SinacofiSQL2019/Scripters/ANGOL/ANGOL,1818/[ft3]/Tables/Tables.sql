...
GO
--SqlScripter----[dbo].[tblVersionEstructura].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
SET ANSI_PADDING ON
...
CREATE TABLE [dbo].[tblVersionEstructura](
	[codMensaje] [varchar](3) NOT NULL,
	[desMensaje] [varchar](20) NOT NULL,
	[nomMensaje] [varchar](3) NOT NULL,
	[lrgMensaje] [int] NOT NULL,
	[bq1Mensaje] [varchar](255) NOT NULL,
	[bq2Mensaje] [varchar](255) NOT NULL,
	[bq3Mensaje] [varchar](255) NOT NULL,
	[periodoInic] [varchar](8) NOT NULL,
	[periodoFin] [varchar](8) NOT NULL,
	[versionMens] [varchar](4) NOT NULL,
	[tipoFormat] [char](1) NOT NULL,
	[fecIngreso] [datetime2](7) NOT NULL,
	[usuIngreso] [varchar](15) NOT NULL
)
ON [PRIMARY]
