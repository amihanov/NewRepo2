...
GO
--SqlScripter----[dbo].[tblLogBloqueoFT3].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
SET ANSI_PADDING ON
...
CREATE TABLE [dbo].[tblLogBloqueoFT3](
	[vcFecha] [varchar](30) NULL,
	[vcHora] [varchar](30) NULL,
	[vcUsuario] [varchar](30) NULL,
	[vcIp] [varchar](30) NULL
)
ON [PRIMARY]
