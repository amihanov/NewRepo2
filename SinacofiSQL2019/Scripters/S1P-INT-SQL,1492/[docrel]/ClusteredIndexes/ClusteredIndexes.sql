...
GO
--SqlScripter----[dbo].[PiezasTemp].[PK_dbo.PiezasTemp].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[PiezasTemp] ADD CONSTRAINT [PK_dbo.PiezasTemp] PRIMARY KEY CLUSTERED (
	[PiezaTempID] ASC
) ON [PRIMARY]

GO
--SqlScripter----[dbo].[PiezasTemp2].[PK_dbo.PiezasTemp2].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[PiezasTemp2] ADD CONSTRAINT [PK_dbo.PiezasTemp2] PRIMARY KEY CLUSTERED (
	[PiezaTempID] ASC
) ON [PRIMARY]
