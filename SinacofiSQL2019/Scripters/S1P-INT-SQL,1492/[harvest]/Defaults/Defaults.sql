...
GO
--SqlScripter----[dbo].[DF__hardelver__DELET__739C96F7].sql
GO
ALTER TABLE [dbo].[hardelversproc] ADD CONSTRAINT [DF__hardelver__DELET__739C96F7] DEFAULT ('N') FOR [DELETEBYOWNER]
GO
...
GO
--SqlScripter----[dbo].[DF__HARPEERRE__CREAT__32C2F7D3].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEW] ADD CONSTRAINT [DF__HARPEERRE__CREAT__32C2F7D3] DEFAULT (getutcdate()) FOR [CREATIONTIME]
GO
--SqlScripter----[dbo].[DF__HARPEERRE__MODIF__33B71C0C].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEW] ADD CONSTRAINT [DF__HARPEERRE__MODIF__33B71C0C] DEFAULT (getutcdate()) FOR [MODIFIEDTIME]
GO
--SqlScripter----[dbo].[DF__HARPEERRE__COMME__46C9F080].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] ADD CONSTRAINT [DF__HARPEERRE__COMME__46C9F080] DEFAULT ('I') FOR [COMMENTTYPE]
GO
--SqlScripter----[dbo].[DF__HARPEERRE__CREAT__47BE14B9].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWCOMMENTDATA] ADD CONSTRAINT [DF__HARPEERRE__CREAT__47BE14B9] DEFAULT (getutcdate()) FOR [CREATIONTIME]
GO
--SqlScripter----[dbo].[DF__HARPEERREV__VOTE__3C4C620D].sql
GO
ALTER TABLE [dbo].[HARPEERREVIEWREVIEWER] ADD CONSTRAINT [DF__HARPEERREV__VOTE__3C4C620D] DEFAULT ('P') FOR [VOTE]
GO
...
GO
--SqlScripter----[dbo].[DF__harudp__ALLOWADD__7490BB30].sql
GO
ALTER TABLE [dbo].[harudp] ADD CONSTRAINT [DF__harudp__ALLOWADD__7490BB30] DEFAULT ('Y') FOR [ALLOWADDITIONALCOMMANDS]
GO
...
GO
--SqlScripter----[dbo].[DF__harversio__ISDAT__7C31DCF8].sql
GO
ALTER TABLE [dbo].[harversiondata] ADD CONSTRAINT [DF__harversio__ISDAT__7C31DCF8] DEFAULT ('0') FOR [ISDATAINCHUNKS]
GO
...
GO
--SqlScripter----[dbo].[DF__USCMMAPPE__SCM_C__01EAB64E].sql
GO
ALTER TABLE [dbo].[USCMMAPPER] ADD CONSTRAINT [DF__USCMMAPPE__SCM_C__01EAB64E] DEFAULT (getutcdate()) FOR [SCM_CREATION_DATE]
GO
