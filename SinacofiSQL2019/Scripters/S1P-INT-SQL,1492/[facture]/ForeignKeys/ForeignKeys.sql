...
GO
--SqlScripter----[dbo].[DTE_SUMA_IMOM].[FK__DTE_SUMA_IMOM__013FDF81].sql
GO
ALTER TABLE [dbo].[DTE_SUMA_IMOM] WITH NOCHECK ADD CONSTRAINT [FK__DTE_SUMA_IMOM__013FDF81] FOREIGN KEY ([codi_empr], [TIPO_DOCU], [FOLI_DOCU])
REFERENCES [dbo].[dte_enca_docu] ([codi_empr], [tipo_docu], [foli_docu])
GO
ALTER TABLE [dbo].[DTE_SUMA_IMOM] WITH CHECK CHECK CONSTRAINT [FK__DTE_SUMA_IMOM__013FDF81]
GO
--SqlScripter----[dbo].[DTE_SUMA_IMOM].[FK__DTE_SUMA_IMOM__7F57970F].sql
GO
ALTER TABLE [dbo].[DTE_SUMA_IMOM] WITH NOCHECK ADD CONSTRAINT [FK__DTE_SUMA_IMOM__7F57970F] FOREIGN KEY ([codi_empr], [TIPO_DOCU], [FOLI_DOCU])
REFERENCES [dbo].[dte_enca_docu] ([codi_empr], [tipo_docu], [foli_docu])
GO
ALTER TABLE [dbo].[DTE_SUMA_IMOM] WITH CHECK CHECK CONSTRAINT [FK__DTE_SUMA_IMOM__7F57970F]
GO
...
GO
--SqlScripter----[dbo].[dte_tipo_bult].[FK__dte_tipo_bult__041C4C2C].sql
GO
ALTER TABLE [dbo].[dte_tipo_bult] WITH NOCHECK ADD CONSTRAINT [FK__dte_tipo_bult__041C4C2C] FOREIGN KEY ([codi_empr], [tipo_docu], [foli_docu])
REFERENCES [dbo].[dte_enca_docu] ([codi_empr], [tipo_docu], [foli_docu])
GO
ALTER TABLE [dbo].[dte_tipo_bult] WITH CHECK CHECK CONSTRAINT [FK__dte_tipo_bult__041C4C2C]
GO
