...
GO
--SqlScripter----[dbo].[dbn_traza_codi_serv].[PK__dbn_traz__CBE71E32EBA9B4FE].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[dbn_traza_codi_serv] ADD CONSTRAINT [PK__dbn_traz__CBE71E32EBA9B4FE] PRIMARY KEY CLUSTERED (
	[codi_serv] ASC
) ON [PRIMARY]
...
GO
--SqlScripter----[dbo].[DTE_SUMA_IMOM].[PK__DTE_SUMA_IMOM__7E6372D6].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[DTE_SUMA_IMOM] ADD CONSTRAINT [PK__DTE_SUMA_IMOM__7E6372D6] PRIMARY KEY CLUSTERED (
	[codi_empr] ASC,
	[TIPO_DOCU] ASC,
	[FOLI_DOCU] ASC,
	[CODI_IMPU] ASC
...
GO
--SqlScripter----[dbo].[dte_tipo_bult].[PK__dte_tipo_bult__032827F3].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[dte_tipo_bult] ADD CONSTRAINT [PK__dte_tipo_bult__032827F3] PRIMARY KEY CLUSTERED (
	[codi_empr] ASC,
	[tipo_docu] ASC,
	[foli_docu] ASC,
	[codi_tibu] ASC
...
GO
--SqlScripter----[dbo].[se_pipe].[PK__se_pipe__2F3AE904].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[se_pipe] ADD CONSTRAINT [PK__se_pipe__2F3AE904] PRIMARY KEY CLUSTERED (
	[pipe_id] ASC
) ON [PRIMARY]
