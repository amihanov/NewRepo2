...
GO
--SqlScripter----[dbo].[dba_CopyLogins].sql
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('[dbo].[dba_CopyLogins]') IS NULL EXEC('CREATE PROCEDURE [dbo].[dba_CopyLogins] AS PRINT ''TEMPORARY OBJECT, DELETE AFTER ALL OBJECTS ARE CREATED''')
GO
