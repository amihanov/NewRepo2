...
-- Drop Database ValidacionTributaria
...
( NAME = N'$(db)_PRIMARY', FILENAME = N'$(RutaPrimary)\$(db)\$(db)_PRIMARY.mdf', SIZE = 22550MB, MAXSIZE = UNLIMITED, FILEGROWTH = 128MB)
LOG ON
( NAME = N'$(db)_LOG', FILENAME = N'$(RutaLog)\$(db)\$(db)_LOG.ldf', SIZE = 4510MB , MAXSIZE = UNLIMITED, FILEGROWTH = 32MB)
