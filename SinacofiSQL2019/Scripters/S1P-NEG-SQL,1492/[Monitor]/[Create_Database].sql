...
( NAME = N'$(db)_PRIMARY', FILENAME = N'$(RutaPrimary)\$(db)\$(db)_PRIMARY.mdf', SIZE = 900MB, MAXSIZE = UNLIMITED, FILEGROWTH = 128MB)
LOG ON
( NAME = N'$(db)_LOG', FILENAME = N'$(RutaLog)\$(db)\$(db)_LOG.ldf', SIZE = 180MB , MAXSIZE = UNLIMITED, FILEGROWTH = 32MB)
