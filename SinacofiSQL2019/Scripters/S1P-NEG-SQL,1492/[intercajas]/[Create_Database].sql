...
( NAME = N'$(db)_PRIMARY', FILENAME = N'$(RutaPrimary)\$(db)\$(db)_PRIMARY.mdf', SIZE = 7500MB, MAXSIZE = UNLIMITED, FILEGROWTH = 128MB)
LOG ON
( NAME = N'$(db)_LOG', FILENAME = N'$(RutaLog)\$(db)\$(db)_LOG.ldf', SIZE = 1500MB , MAXSIZE = UNLIMITED, FILEGROWTH = 32MB)
